    ...
    <div className="fixed bottom-10 left-[30rem] transform translate-x-1/2  translate-y-1/2 z-50 bg-[#0f0f0f] border w-[30%] px-[4rem] mb-[2rem] rounded">
      <section className="flex justify-between items-center">
        ...
        <div className="flex justify-center items-center mb-[2rem]">
          ...
          <Link
            to="/movies"
            className="text-white flex items-center transition-transform transform hover:translate-x-2 ml-[1rem]"
          >
          ...
          {!userInfo && (
            <ul className="flex">
              <li>
                <Link
                  to="/login"
                  className="text-white flex items-center transition-transform transform hover:translate-x-2 mb-[2rem]"
                >
              ...
              <li>
                <Link
                  to="/register"
                  className="text-white flex items-center transition-transform transform hover:translate-x-2 ml-[2rem]"
                >
